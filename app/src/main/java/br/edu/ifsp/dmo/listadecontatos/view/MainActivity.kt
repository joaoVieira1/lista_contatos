...
class MainActivity : AppCompatActivity(), OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(savedInstanceState != null){
            listDatasource = savedInstanceState.getSerializable("list_contacts") as ArrayList<Contact>
        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        //salvando lista para ser reutilizada posteriormente
        outState.putSerializable("list_contacts", listDatasource)
    }
